      ...
      >
        ...
        >
          ...
          <a
            ...
            className="px-8 py-3.5 border border-runway-700 text-runway-700 font-semibold rounded-lg hover:bg-runway-700 hover:text-white hover:scale-105 active:scale-95 transition-all duration-300 shadow-3d-sm hover:shadow-3d-md"
          >
            LinkedIn Profile
          </a>
        </motion.div>
